const ITeamFinance = [
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: "uint256", name: "fees", type: "uint256" },
    ],
    name: "FeesChanged",
    type: "event",
  },
  ...
  },
  {
    ...
    name: "priceEstimator",
    outputs: [
      { internalType: "contract IPriceEstimator", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  {
    inputs: [
      { internalType: "address", name: "_priceEstimator", type: "address" },
      { internalType: "address", name: "_usdTokenAddress", type: "address" },
  ...
  {
    inputs: [{ internalType: "uint256", name: "_feesInUSD", type: "uint256" }],
    name: "setFeesInUSD",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "_referrerCut", type: "uint256" },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "_splitUnlockTime", type: "uint256" },
      { internalType: "bool", name: "_mintNFT", type: "bool" },
    ],
    name: "splitLock",
    outputs: [
